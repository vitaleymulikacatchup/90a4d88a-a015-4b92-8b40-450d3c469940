...
export const metadata: Metadata = {
  title: "Visit Sicily - Discover Mediterranean Paradise",
  description: "Explore Sicily's ancient temples, volcanic landscapes, and authentic cuisine. Plan your perfect Mediterranean adventure with expert local insights.",
  keywords: "Sicily travel, Mediterranean vacation, Mount Etna, Taormina, Palermo, Italian tourism, Sicily destinations",
  metadataBase: new URL("https://visitsicily.com"),
  alternates: {
    canonical: "https://visitsicily.com"
  },
  openGraph: {
    title: "Visit Sicily - Discover Mediterranean Paradise",
    description: "From ancient Greek temples to volcanic adventures, discover Sicily's timeless beauty and authentic experiences.",
    siteName: "Visit Sicily",
    images: [{
      url: "https://images.pexels.com/photos/4064447/pexels-photo-4064447.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Sicily Mount Etna Mediterranean landscape"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Visit Sicily - Mediterranean Paradise Awaits",
    description: "Discover Sicily's ancient wonders, volcanic landscapes, and culinary delights.",
    images: ["https://images.pexels.com/photos/4064447/pexels-photo-4064447.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
